...
class TodoForm(ModelForm):
    class Meta:
        model = Todo
        #fields = ['name_todo', 'category', 'pub_date', 'deadline_date', 'description_todo']
        fields = ['name_todo', 'category', 'deadline_date', 'description_todo']
        labels = {
            'name_todo': _('Создайте задание'),
            'category': _('Выберите категорию'),
            #'pub_date': _('Укажите дата создания (формат: 03.02.2021 20:43:35)'),
